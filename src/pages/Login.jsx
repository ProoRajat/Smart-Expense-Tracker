...
import { apiLogin, isApiEnabled } from '../api/client'
    ...
    <div className="min-h-screen bg-surface dark:bg-surface-dark flex flex-col px-4 py-12 md:max-w-md md:mx-auto md:py-24">
      ...
      >
        ...
        <p className="mt-2 text-muted dark:text-muted-dark">
          Sign in to continue to your money companion.
        </p>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <label className="block">
            ...
            <input
              ...
              className="mt-1.5 w-full min-h-[48px] px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-card dark:bg-card-dark text-gray-900 dark:text-white placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary touch-manipulation"
        ...
        {!isApiEnabled() && (
          <p className="mt-4 text-sm text-muted dark:text-muted-dark text-center">
            Backend not configured. Set <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">VITE_API_URL</code> and run the API to sign in.
          </p>
        )}
